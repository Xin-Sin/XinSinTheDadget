...
public class RandomWindow extends BorderPane {
    ...
    *//**
    ...
    public RandomWindow() {
        ...
        setStyle("-fx-background-image: url(/res/Images/Background/background.png);-fx-background-repeat: no-repeat");
        setTop(getMenubar());
        setLeft(vBox());
        setCenter(VBox1());
    }
    *//**
    ...
    private Button getRandomButton(){
        Button random = new Button("",new ImageView("/res/Images/Icon/Random.png"));
    ...
    *//**
    ...
    private MenuItem classes(){
        ...
        classes.setOnAction(e ->{
            NameRead nameRead = new NameRead();
            Thread thread = new Thread(nameRead);
            nameRead.setIndex("1");
            thread.start();
        });
        return classes;
    ...
    *//**
    ...
    private Stage newTextArea(){
        ...
        newTextArea.getIcons().add(new Image("/res/Images/Icon/logo.png"));
