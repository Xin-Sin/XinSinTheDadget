...
public class randomOrderMain extends Application {
    ...
    public void start(Stage pStage) throws Exception {
        ...
        if (file.listFiles().length == 0){
            stage.setScene(new Scene(FXMLLoader.load(this.getClass().getResource("/Fxml/FirstUseWindow.fxml"))));
        }else{
            stage.setScene(new Scene(FXMLLoader.load(this.getClass().getResource("/Fxml/MainWindow.fxml"))));
        }
        stage.show();
    }
}